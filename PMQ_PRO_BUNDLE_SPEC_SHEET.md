...
|---|---|---|---|
| Price | Free | **£20.00** one-off | £30.00 one-off |
...
through a purchase. Do not describe Sly as part of the £20 Pro Bundle.
...
|---|---|---|---|
| `pmq-in-5-days` | ~~`exam_config.ai_tutor_price_cents: 999`~~ **resolved 2026-09-21: now 2000** | 2000 | none |
...
Checkout passes an explicit amount, so live charges are correct at £20 today.
...
correct: PMQ the *course* is free, and £20 buys the Pro Bundle on top. Do not "fix" it.
