...
- **Monetization:** one-time unlocks, never subscriptions. Canonical prices live in `src/lib/courses/registry-data.ts` (`COURSE_STATIC[*].priceCents`) — that value is what Stripe charges and what the pricing cards render, so never quote a price anywhere without deriving it from there. As of 2026-09-21: **PMQ Pro Bundle £15** (Starter free), **PMQ AI Pro Bundle £25** (waitlist, indicative, not charged), **PFQ Pro Bundle £10** (Free scaffolding + LO1 insights; Pro unlocks rest), **PFQ AI Pro Bundle £20** (waitlist, indicative; £10 Pro→AI Pro upgrade later). The £5 Sly fair-usage credit (`SLY_UNLOCK_CREDIT_GBP_CENTS`) rides on the tier that actually carries Sly. Price history: PMQ Pro £9.99 decided 2026-07-01, locked 2026-07-13/14, moved to £8 on 2026-07-31, **moved to £15 on 2026-09-21**; PMQ AI Pro £15 → **£25 on 2026-09-21**; PFQ AI Pro £15 → £20 on 2026-09-15.
