...
- **2026-09-21** — Footer nav spacing: equal spread only on narrow phones (`justify-between`); from `sm` cluster with gap; `lg` stays end-aligned — stops iPad from stretching links edge-to-edge (`SiteFooter`).
