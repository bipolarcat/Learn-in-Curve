...
- **2026-09-21** — PFQ Starter Pro-lock toasts match PMQ: Insights chip (`InsightsLockedChip` / `showProLockHint`); locked mock rows tap → “Unlock mock exams with the Pro bundle.” (`PfqMockConsole`). PFQ has no Pair/Group/Line content yet.
