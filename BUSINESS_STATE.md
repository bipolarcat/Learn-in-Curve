...
- **2026-09-21** — Free mock hierarchy: quiz card elevated (`quizPrimary`); FAQ demoted to quiet hairline accordion (`FaqAccordion` `variant="quiet"`, “Common questions”) so the two consoles no longer read as twins (`FreeMockExamShell`, `FreeMockExam.module.css`).
