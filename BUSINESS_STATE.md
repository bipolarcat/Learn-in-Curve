...
- **2026-09-15** — Learn “Back to Top”: icon + label on the left edge of the Continue row (Continue stays centred); circular scroll-progress + magnetic pull (`LearnBackToTopButton`, `StudyJourney`).
