...
- **2026-09-15** — Learn Contents jump uses a Framer spring scroll (bounce 0.12) instead of native `smooth` — less choppy on mobile (`Lo1CoreContentStudy`).
- **2026-09-15** — Learn Contents jump: outcome separator lands on the sticky Contents pill midline (`pt-3` + half `h-9`) instead of the viewport top (`Lo1CoreContentStudy`).
