...
- **2026-09-15** — Learn “Back to Top”: progress-ring icon + label on the left edge (no arrow); Continue stays dead-centred on mobile (`LearnBackToTopButton`, `StudyJourney`).
