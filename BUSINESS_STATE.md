...
- **2026-09-21** — PMP free-mock results disclaimer: affiliation sentence only (`PMI_DISCLAIMER` in `legal-copy.ts`; test updated).
- **2026-09-21** — Free mock gate CTA “Show my results”: sentence case (all three exams share `FreeMockExamClient`).
- **2026-09-21** — Free mock results eyebrow: “{mark} Mock Exam result” (was “Your readiness check”) (`FreeMockExamClient`).
