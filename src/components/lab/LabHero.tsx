...
function CategoryStamp() {
  ...
  return (
    <motion.p
      className="mb-0.5 -mt-0.5 text-center font-body text-[13px] font-bold leading-snug tracking-[0.12em] text-teal sm:mb-0 sm:translate-y-1.5 sm:text-[17px] sm:tracking-[0.1em]"
