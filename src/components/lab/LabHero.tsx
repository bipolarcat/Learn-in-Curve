...
function CategoryStamp() {
  ...
  return (
    <motion.p
      className="mb-0 mt-1 text-center font-body text-[13px] font-bold leading-snug tracking-[0.12em] text-teal sm:mb-0 sm:mt-2 sm:translate-y-3 sm:text-[17px] sm:tracking-[0.1em]"
