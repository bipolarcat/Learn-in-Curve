...
function CategoryStamp() {
  ...
  return (
    <motion.p
      className="mb-2.5 text-center font-body text-[13px] font-bold leading-snug tracking-[0.12em] text-teal underline decoration-teal/40 underline-offset-[0.35em] sm:mb-3 sm:text-[14px] sm:tracking-[0.14em]"
