...
function CategoryStamp() {
  ...
  return (
    <motion.p
      className="mb-0 mt-2 text-center font-body text-[13px] font-bold leading-snug tracking-[0.12em] text-teal sm:mb-0 sm:mt-3 sm:translate-y-5 sm:text-[17px] sm:tracking-[0.1em]"
