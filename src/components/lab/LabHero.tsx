...
function CategoryStamp() {
  ...
  return (
    <motion.p
      aria-label={EYEBROW}
      className="mb-3 max-w-[36rem] text-balance text-center font-display text-[clamp(1.55rem,4vw,2.25rem)] font-semibold leading-[1.12] tracking-[-0.025em] text-ink sm:mb-4 sm:max-w-none"
