  ...
  const card = (
    <ScrollReveal className="mx-auto w-full max-w-[46rem] md:max-w-none">
      <div
        className={
          embedded
            ? "flex min-h-0 flex-col overflow-hidden rounded-[1.35rem] border border-white/10 bg-paper p-3.5 text-ink shadow-[0_1px_0_rgb(255_255_255_/_0.12),0_22px_48px_-18px_rgb(0_0_0_/_0.5)] sm:rounded-2xl sm:p-5 md:min-h-[35.75rem] md:p-6 lg:p-7"
            : "flex min-h-0 flex-col overflow-hidden rounded-2xl border border-ink/10 bg-paper p-3.5 shadow-[0_1px_0_rgb(var(--ink-rgb)_/_0.04),0_12px_28px_-18px_rgb(var(--ink-rgb)_/_0.28)] sm:p-5 md:min-h-[35.75rem] md:p-6 lg:p-7"
        }
      >
        <header className="mb-4 sm:mb-5">
          ...
          >
            Real <span className="text-orange">PMQ</span> Practice
          </h2>
