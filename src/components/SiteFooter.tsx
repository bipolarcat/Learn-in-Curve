...
/**
 * Full-bleed ink footer — logo left; newsletter + legal links share one row
 * on the right. “Be Curious.” flicker below.
 *
    ...
    <footer className="relative bg-ink pb-0 pt-7 text-cream sm:pt-9">
      <div className="wrap relative z-[1] pb-5 sm:pb-6">
        <div className="flex flex-col gap-4 sm:gap-5 lg:flex-row lg:items-center lg:justify-between lg:gap-8">
          ...
          <div className="flex min-w-0 flex-col gap-3 sm:items-end lg:max-w-[min(100%,34rem)]">
            <div className="flex w-full min-w-0 flex-wrap items-center gap-x-3 gap-y-2 sm:justify-end">
              <section
                id="newsletter"
                aria-labelledby="footer-newsletter-heading"
                className="flex min-w-0 max-w-[15.5rem] flex-1 items-center gap-1.5 sm:flex-none sm:max-w-[14.5rem]"
              >
                <div
                  className="flex h-6 w-6 shrink-0 items-end justify-center"
                  aria-hidden
                >
                  <NotifyMailboxMark className="h-full w-full" />
                </div>
                <h2 id="footer-newsletter-heading" className="sr-only">
                  Join our newsletter
                </h2>
              ...
              <nav
                aria-label="Footer"
                className="flex flex-wrap items-center gap-x-3.5 gap-y-0.5 sm:gap-x-4"
              >
