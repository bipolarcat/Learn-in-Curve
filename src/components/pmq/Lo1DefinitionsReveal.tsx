  ...
  return (
    <div
      className={cn(
        ...
        open
          ? "border-teal/35 shadow-[0_1px_2px_rgb(var(--ink-rgb)_/_0.04),0_0_0_1px_rgb(var(--teal-rgb)_/_0.12)] md:col-span-2"
    ...
    >
      <h3 className="m-0">
        <button
          ...
          onClick={onToggle}
          onKeyDown={onKeyDown}
          className="flex w-full min-h-11 items-center gap-2.5 px-3.5 py-3 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange/55 focus-visible:ring-offset-2 focus-visible:ring-offset-paper"
        >
          <span
            className={cn(
