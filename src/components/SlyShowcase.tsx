 ...
 *
 * Composition: same “product on a stage” idea as `HomeMethodBand`, but a quiet
 * paper stadium (not teal). Copy stays; the stage + console lift supply presence.
 *
  ...
  return (
    ...
    >
      <div className={styles.panel}>
        <div className={`wrap relative z-[1] ${styles.inner}`}>
