...
import { CtaArrow, stampCtaPrimary, stampCtaPrimaryCompact } from "@/components/stamp-chip";
      ...
      >
        <div className="flex w-full items-center gap-2">
          ...
          <button
            ...
            className={`${stampCtaPrimary} !normal-case shrink-0 justify-center disabled:opacity-60`}
          >
            {status === "submitting" ? (
              <Spinner
                variant="ellipsis"
