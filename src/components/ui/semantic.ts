...
/** Ink (black) fill CTA — primary hero conversion. */
export const marketingActionInk =
  `group inline-flex min-h-11 w-fit items-center justify-center gap-2 rounded-xl border border-transparent bg-ink px-5 font-body text-[11px] font-bold uppercase tracking-[0.06em] text-paper hover:brightness-[1.12] sm:min-h-12 sm:px-6 sm:text-[12px] ${actionFocus} ${actionMotion}`;
...
export const marketingActionInkFlat = marketingActionInk;
