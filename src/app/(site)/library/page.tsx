        ...
        >
          <header className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-[36rem] text-pretty font-body text-[16px] leading-relaxed text-ink/80">
              Direct answers to the questions candidates actually ask — then a
              free readiness check when you want to test yourself.
            </p>
          </header>

          <div className="mt-10 space-y-10">
            {publishedCount === 0 ? (
              <div className="rounded-xl border border-ink/10 bg-cream/60 px-5 py-6 text-center">
                ...
                <p className="mt-2 font-body text-[14.5px] text-ink/70">
                  {draftCount} draft page{draftCount === 1 ? "" : "s"} in
                  progress. Meanwhile, take the free mock.
                </p>
                <Link
                  href="/free-mock-exam"
